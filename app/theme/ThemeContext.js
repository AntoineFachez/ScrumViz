...
const styled = (colorMode) => ({
  ...
  space: {
    ...
    alignItems: 'center',
    // backgroundColor: 'red',
    // backgroundColor:() => themeSettings('dark').neutral.light,
    // backgroundColor: () => themeSettings(colorMode).neutral.light,
    overflow: 'scroll',
    backgroundColor: () => themeSettings(colorMode).transparent,
    // margin: 0,
  ...
  widgetMenuButton: {
    ...
    // // height: "100%",
    // height: "2rem",
    // color:() => themeSettings('dark').neutral.light,
    // backgroundColor:() => themeSettings('dark').transparent,
    // "&:hover": {
    //   color:  () => themeSettings(colorMode).neutral.light,
    //   backgroundColor:() => themeSettings('dark').neutral.light,
  ...
  chip: {
    ...
    multilines: {
      height: 'auto',
      border: `1px solid ${() => themeSettings('dark').neutral.light}`,
  ...
  histogram: {
    ...
    ticks: {
      heightY1: '10px',
      heightY2: '10px',
      stroke: 'rgba(10,10,20,1)', //TODO: check if rgb else "() => themeSettings('dark').neutral.dark"
      strokeWidth: 1,
      zIndex: 100,
      position: 'relative',
    },
